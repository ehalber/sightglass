...
To use these stylesheets, rename the files and sightglass with the name of your theme.
...
sightglass-alpha-default-narrow.css  
...
sightglass-alpha-default-normal.css
...
sightglass-alpha-default-wide.css
